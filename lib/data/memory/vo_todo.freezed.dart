...
class _$TodoImpl with DiagnosticableTreeMixin implements _Todo {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Todo(id: $id, title: $title, dueDate: $dueDate, modifyTime: $modifyTime, status: $status, createdTime: $createdTime)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, dueDate, modifyTime, status, createdTime);
